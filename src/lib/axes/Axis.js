...
class Axis extends Component {
    ...
    render() {
        const { bg, axisZoomCallback, className, zoomCursorClassName, zoomEnabled, getScale, inverted } =
            this.props;
...
function tickHelper(props, scale) {
    ...
    const format = isNotDefined(tickFormat) ? baseFormat : d => tickFormat(d) || "";
...
function axisTicksSVG(props, scale) {
    ...
    const { tickLabelFill, tickStroke, tickStrokeOpacity, tickStrokeWidth, tickStrokeDasharray, textAnchor } =
        result;
