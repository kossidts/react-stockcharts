...
class EventCapture extends Component {
    ...
    handleWheel(e) {
        ...
        // inside componentDidMount : this.myRef.current.addEventListener('wheel', this.handleWheel, { passive: false });
        // inside componentWillUnmount : this.myRef.current.removeEventListener('wheel', this.handleWheel, { passive: false });
        e.preventDefault();
    ...
    handlePinchZoom(e) {
        ...
        const { ...initialPinch } = this.state.pinchZoomStart;
