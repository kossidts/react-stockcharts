...
import { OHLCTooltip, MovingAverageTooltip, StochasticTooltip } from "react-stockcharts/lib/tooltip";
    ...
    render() {
        ...
        return (
            <ChartCanvas
                ...
                xExtents={xExtents}
            >
                <Chart id={1} height={325} yExtents={d => [d.high, d.low]} padding={{ top: 10, bottom: 20 }}>
