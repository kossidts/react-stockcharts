...
import { BarSeries, OHLCSeries, LineSeries, MACDSeries } from "react-stockcharts/lib/series";
    ...
    render() {
        ...
        return (
            <ChartCanvas
                ...
                xExtents={xExtents}
            >
                <Chart id={1} height={300} yExtents={d => [d.high, d.low]} padding={{ top: 10, bottom: 10 }}>
